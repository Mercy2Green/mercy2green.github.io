...
<div class="game-home">
  ...
  <h3 class="section-title">Played Games</h3>
  <ul class="played-list">
    <li class="played-item">Dark Souls III</li>
    <li class="played-item">NieR: Automata</li>
    <li class="played-item">Ghost of Tsushima</li>
    <li class="played-item">It Takes Two</li>
    <li class="played-item">Resident Evil 4</li>
    <li class="played-item">Monster Hunter: World</li>
    <li class="played-item">Civilization VI</li>
    <li class="played-item">Slay the Spire</li>
    <li class="played-item">Dead Cells</li>
    <li class="played-item">Outer Wilds</li>
    <li class="played-item">Portal 2</li>
    <li class="played-item">GTA V</li>
    <li class="played-item">Apex Legends</li>
    <li class="played-item">Overwatch 2</li>
    <li class="played-item">Celeste</li>
    <li class="played-item">Stardew Valley</li>
    <li class="played-item">Terraria</li>
    ...
    <li class="played-item">Diablo IV</li>
  </ul>
</div>
